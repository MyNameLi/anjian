...
public class GetImage : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string idolPort = ConfigurationManager.AppSettings["IdolHttp"];
        var requestUrl = string.Format("http://{2}:9000/action={0}&SourceJobname={1}", action, SourceJobname, idolPort);
