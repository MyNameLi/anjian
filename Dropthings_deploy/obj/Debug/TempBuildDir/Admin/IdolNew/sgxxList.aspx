<%@ page language="C#" autoeventwireup="true" inherits="Admin_IdolNew_sgxxList, Dropthings_deploy" enableEventValidation="false" theme="GreenBlue" %>
                            ...
                            <td bgcolor="#d3e7fc">
                              ...
                              <span class="input"><select id="info_site" style="width:60px;">>
                                    <option selected="selected" value="all">全部</option>
                                                    ...
                                                    <li style="display: none;"><span>数据源：
                                ...
                                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CECECE">
                                    <tr>
                                        ...
                                        <td width="28%" background="../images/tab_14.gif" align="center">
                                            标题
                                        </td>
                                        ...
                                        <td width="10%" id="dis_article_column" style="display: none;" background="../images/tab_14.gif"
                                            align="center">
                                            所属栏目
                                        </td>
                                    </tr>
