<%@ page language="C#" autoeventwireup="true" inherits="Admin_IdolNew_changeDataBase, Dropthings_deploy" enableEventValidation="false" theme="GreenBlue" %>
                                        ...
                                        <tr>
                                            <td bgcolor="#ffffff">
                                                <ul class="form_list">
                                                    ...
                                                    <li><span id="databse_list" style="padding-left: 22px;">
                                                        <%--style="padding-left:22px;"新加20120507--%>
                           ...
                           <input type="checkbox" name="databse_list"  value="bbs" />信息回收站                --%>
                                ...
                                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CECECE">
                                    <tr>
                                        ...
                                        <td width="30%" background="../images/tab_14.gif" align="center">
                                            标题
                                        </td>
                                        ...
                                        <td width="15%" id="look_same_news" style="display: none;" background="../images/tab_14.gif"
                                            align="center">
                                            查看相同新闻
                                        </td>
                                    </tr>
