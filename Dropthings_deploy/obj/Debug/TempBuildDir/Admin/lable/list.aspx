<%@ page language="C#" autoeventwireup="true" inherits="Admin_lable_list, Dropthings_deploy" enableEventValidation="false" theme="GreenBlue" %>
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        &nbsp;&nbsp;&nbsp;<span><asp:Button ID="BtnRefresh" runat="server" Text="刷新所有标签" 
            ...
            <asp:Repeater ID="dataList" runat="server">
                <HeaderTemplate>
                  <tr>
                    ...
                    <td width="24%" background="../images/tab_14.gif" align="center">标签名称</td>
                    <td width="56%" background="../images/tab_14.gif" align="center">标签对应值</td>                    
          ...
          <tr>
            <td width="21%" align="left">
                ...
                <a href="javascript:void(null);" onClick="javascript:listTable.InnitAdd();">
                    <img alt="新增" src="../images/x.gif" width="55" height="19" /> 
                </a>
...
<div id="column_edit_frame" class="layerdiv">
  ...
  <div class="layer_inner"> 
    <div class="layer_move" id="move_column" title="点击此处可自由拖动"><h1>标签管理</h1></div>
