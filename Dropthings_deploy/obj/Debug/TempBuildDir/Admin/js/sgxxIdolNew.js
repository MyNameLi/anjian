...
var IdolNew = _idolnew.property = {
    ...
    Innit: function () {
        ...
        //        }
        //IdolNew.queryParams["database"] = "NewPortal";
                    ...
                    if (data) {
                        if (data.Success == 1) {
                            ...
                            for (var item in data) {
                                $("#all_data_list").find("td[name='column_article_list'][pid='" + item + "']").empty().html(unescape(data[item])).parent("tr").find("td").addClass("dingzhicss");//.attr("style", "background-color:#efefdf"); 
