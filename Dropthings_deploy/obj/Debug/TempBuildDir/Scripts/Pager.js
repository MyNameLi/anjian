    ...
    if (query_params["display_style"] == 6 || query_params["display_style"] ==8) {
        ...
        $.ajax({
            ...
            beforeSend: function(XMLHttpRequest) {
                $("#" + obj.result_id).empty().html("<center style=\"font-size:12px;\">数据正在加载中……</center>");
                //$("#" + obj.result_id).empty().html("<center style=\"font-size:12px;\"><img src=\"img/loading_icon.gif\" /></center>");
