...
SqlPager.prototype.Init_status_bar = function(current_page) {
    ...
    if (this.status) {
        ...
        if (this.page_count > 1) {
            ...
            content.push("<span><a href=\"javascript:void(null);\" id=\"btn_look_skip_" + this.sql_tag + "\">转</span>");
        }
...
SqlPager.prototype.LoadData = function(page_index, query_params) {
    ...
    $.ajax({
        ...
        beforeSend: function(XMLHttpRequest) {
            $("#" + obj.result_id).empty().html("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\"><tr><td align=\"center\" class=\"loading_text\" colapan=\"200\"><img src=\"images/loading_icon.gif\" /></td></tr></table>");
            $("#" + obj.info_id).empty().html("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\"><tr><td align=\"center\" class=\"loading_text\" colapan=\"200\"><img src=\"images/loading_icon.gif\" /></td></tr></table>");
        },
        dataType: "json",
        success: function(data) {
            if (data) {
                ...
                $("#" + obj.result_id).html("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\"><tr><td align=\"center\" class=\"loading_text\" colapan=\"200\">对不起，没有数据</td></tr></table>");
