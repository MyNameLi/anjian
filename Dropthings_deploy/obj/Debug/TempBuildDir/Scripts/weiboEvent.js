    ...
    loadWeiboTopic: function() {
        ...
        sp.Display = function(data, l_obj) {
            ...
            while (entity) {
                ...
                weibo_topics.push("<td class=\"center\"><a class=\"btn_edit\" href=\"javascript:void(null);\" name=\"weibo_topic_edit\" pid=\"topic_edit_" + entity["ID"] + "\">编辑</a></td>");
            ...
            function(data) {
                if (data && data["Success"] == 1) {
                    ...
                    while (entity) {
                        ...
                        industryCate.push("<td class=\"center\"><a class=\"btn_edit\" href=\"javascript:void(null)\" name=\"updateIndustryCategory\" cateid=\"" + cateid + "\">编辑</a></td>");
                        industryCate.push("<td class=\"center\"><a class=\"btn_delete\" href=\"javascript:void(null)\" name=\"delIndustryCategory\" cateid=\"" + cateid + "\">删除</a>");
            ...
            function(data) {
                if (data && data["Success"] == 1) {
                    ...
                    while (entity) {
                        ...
                        industryCate.push("<td class=\"center\"><a class=\"btn_edit\" href=\"javascript:void(null)\" name=\"updateKeywords\" cateid=\"" + cateid + "\">编辑</a></td>");
                        industryCate.push("<td class=\"center\"><a class=\"btn_delete\" href=\"javascript:void(null)\" name=\"delKeywords\" cateid=\"" + cateid + "\">删除</a>");
