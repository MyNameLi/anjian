<%@ control language="C#" autoeventwireup="true" inherits="Footer, Dropthings_deploy" enableviewstate="false" %>
<div id="footer">
    <div id="footer_wrapper">

        <p class="copyright">&copy; <a href="#"> ∞Ê»®–≈œ¢</a>. <asp:Literal ID="ltlCopyright" EnableViewState="false" runat="server" Text="<%$Resources:SharedResources, Copyright%>" /> <br />
