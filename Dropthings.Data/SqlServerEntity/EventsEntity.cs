...
namespace Dropthings.Data.SqlServerEntity
{
    ...
    public partial class EventsEntity
    {
        ...
        public EventsEntity(int id, int eventid, string summary, string eventname, DateTime eventtime, string keywords)
        {
            this.ID = id;
        ...
        public class EventsDAO : SqlDAO<EventsEntity>
        {
            ...
            public override void Add(EventsEntity entity)
            {
                ...
                strSql.Append("EventId,Summary,EventName,EventTime,KeyWords)");
            ...
            public override void Update(EventsEntity entity)
            {
                ...
                parameters[2].Value = entity.Summary;
                parameters[3].Value = entity.EventName;
                parameters[4].Value = entity.EventTime;
                parameters[5].Value = entity.KeyWords;
