...
namespace Dropthings.Data.SqlServerEntity
{
    ...
    public partial class EventImgEntity
    {
        ...
        public struct Columns
        {
            ...
            public const string ImgTitle = "ImgTitle";
        }
        #endregion
        ...
        public EventImgEntity(int imgid, int eventid, string imgpath, string imgurl, int imgtype, string imgtitle)
        {
            this.ImgId = imgid;
        ...
        public class EventImgDAO : SqlDAO<EventImgEntity>
        {
            ...
            public override void Add(EventImgEntity entity)
            {
                ...
                strSql.Append("EventId,ImgPath,ImgUrl,ImgType,ImgTitle)");
                ...
                SqlParameter[] parameters = {
					...
					new SqlParameter("@ImgType",SqlDbType.Int),
					new SqlParameter("@ImgTitle",SqlDbType.VarChar)
					};
                parameters[0].Value = entity.EventId;
                parameters[1].Value = entity.ImgPath;
                parameters[2].Value = entity.ImgUrl;
                parameters[3].Value = entity.ImgType;
                parameters[4].Value = entity.ImgTitle;
            ...
            public override void Update(EventImgEntity entity)
            {
                ...
                parameters[4].Value = entity.ImgType;
                parameters[5].Value = entity.ImgTitle;
            ...
            public override EventImgEntity FindById(long primaryKeyId)
            {
                ...
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count == 1)
                {
                    ...
                    if (!Convert.IsDBNull(row["ImgType"]))
                    {
                        entity.ImgType = (int)row["ImgType"];
                    }
                    entity.ImgTitle = row["ImgTitle"].ToString();
                    return entity;
                }
                else
                {
