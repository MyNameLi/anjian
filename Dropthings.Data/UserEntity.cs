    ...
    public partial class UsersEntity
    {
        ...
        public class UsersDAO : SqlDAO<UsersEntity>
        {
            ...
            public DataTable GetPager(string where, SqlParameter[] param, string orderBy, int pageSize, int pageNumber)
            {
                ...
                PagerSql.AppendFormat("SELECT * FROM( SELECT ROW_NUMBER()OVER( ORDER BY USERID) AS RN,* FROM dbo.USERS where {0} ) AS T WHERE T.RN BETWEEN {1} AND {2}", where, startNumber, endNumber);
