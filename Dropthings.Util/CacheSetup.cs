...
namespace Dropthings.Util
{
    public class CacheKeys
    {
        public static class WidgetKeys
        {
            ...
            public static string[] InstanceWidgetTab(int tabId)
            {
                return new string[] { "InstanceWidgetTab." + tabId };
            }
        ...
        public class TabKeys
        {
            ...
            //public static string[] TabOfWidgetInstance(int wiId)
            //{
            //    return new string[] { "TabOfWidgetInstance." + wiId };
            //}
        ...
        public class UserKeys
        {
            ...
            {
                return "UserIDFromUserName." + userName;
            }
            public static string UserFromUserName(string userName)
            {
                return "UserFromUserName." + userName;
            }
            public static string UserFromUserID(int userID)
            {
                return "UserFromUserID." + userID.ToString();
            }
            public static string TabsOfUser(int userID)
            {
                return "TabsOfUser." + userID.ToString();
            }
            public static string RoleTemplateByUser(string userName)
            {
                return "RoleTemplateByUser." + userName;
            }
            public static string UserSettingByUserID(int userID)
            {
                return "UserSettingByUserID." + userID.ToString();
            }
            ...
            public static string[] AllUserGuidBasedKeys(int userID)
            {
                return new string[] 
                {
                    UserSettingByUserID(userID),
                    UserFromUserID(userID), 
                    TabsOfUser(userID),
                    TemplateKeys.RoleTemplateByUser(userID),
                    RolesOfUser(userID)
                };
            }

            public static string RolesOfUser(int userID)
            {
        ...
        public class TemplateKeys
        {
            ...
            public static string RoleTemplateByUser(int userid)
            {
                return "RoleTemplateByUser." + userid.ToString();
            }
        }
