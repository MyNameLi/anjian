namespace Dropthings.Business.Facade
{
    ...
    public partial class Facade : IDisposable
    {
        ...
        private IUsersInRoleRepository usersInRoleRepository { get { return Resolve<IUsersInRoleRepository>(usersInRoleRepositoryResolver); } }
        ...
        private readonly Func<IUsersInRoleRepository> usersInRoleRepositoryResolver;
        ...
        public Facade(AppContext context) :
            ...
            Services.LazyGet<IUsersInRoleRepository>(),
        ...
        public Facade(AppContext context,
            ...
            Func<IUsersInRoleRepository> usersInRoleRepository,
            Func<IUserSettingRepository> userSettingRepository)
        {
            ...
            this.usersInRoleRepositoryResolver = usersInRoleRepository;
        }
        ...
        public static void BootStrap()
        {
                ...
                .Do(() =>
            {
                ...
                Services.RegisterTypeForLazyGet<IUsersInRoleRepository>(r => new UsersInRoleRepository(
                    /*r.Resolve<IDatabase>(),*/ r.Resolve<ICache>()));
                ...
                Services.RegisterType<IUsersInRoleRepository, UsersInRoleRepository>(dalConstructor);
#endif
            });
        }
