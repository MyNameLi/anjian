<%@ page language="C#" autoeventwireup="true" inherits="Admin_sitemanage_list, Dropthings_deploy1" enableEventValidation="false" theme="GreenBlue" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var len = $("#all_data_list").find("a[name='enter_website_manage']").length;

            $("#all_data_list").find("a[name='enter_website_manage']").each(function(n) {
                if (len == 1 && n == 0) {
                    var site_id = $(this).attr("pid");
                    $.post(location.href,
			            { "act": "entersitemanage", "ajaxString": 1, "idList": site_id },
			            function(data) {
			                if (data.Success == "1") {
			                    parent.document.getElementById("mainFrame").src = "leftMenu/Left.html?parentid=2";
			                }
			            },
			            "json"
		            );
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../images/tab_05.gif" align="left"><img src="../images/311.gif" width="16" height="16" /> <span class="STYLE4">站点列表</span>        
        </td>
            ...
            <asp:Repeater ID="dataList" runat="server">
                <HeaderTemplate>
                  <tr>
                    ...
                    <td width="24%" background="../images/tab_14.gif" align="center">站点名称</td>
                    <td width="46%" background="../images/tab_14.gif" align="center">站点对应域名</td>                    
                    <td width="7%" background="../images/tab_14.gif" align="center">编辑</td>
                   <%-- <td width="7%" background="../images/tab_14.gif" align="center">删除</td>--%>
                    <td width="10%" background="../images/tab_14.gif" align="center">进入站点管理</td>
                  </tr>          
                ...
                <ItemTemplate>
                  <tr>
                    ...
                    <td bgcolor="#FFFFFF" align="center"><%#Eval("SITENAME")%></td>
                    <td bgcolor="#FFFFFF" align="center"><a href="#"><%#Eval("DOMAINNAME")%></a></td>
                   ...
                   <%-- <td bgcolor="#FFFFFF" align="center"><img src="../images/010.gif" width="9" height="9" />[ <a href="javascript:void(null);" onClick="javascript:listTable.Remove(<%#Eval("ID") %>,'您确定要删除么？');">删除</a> ]</td>--%>
                    <td bgcolor="#FFFFFF" align="center"><img src="../images/037.gif" width="9" height="9" />[ <a href="javascript:void(null);" name="enter_website_manage" pid="<%#Eval("ID") %>">进入</a> ]</td>
                  </tr>  
                </ItemTemplate>  
                <FooterTemplate>
                    </tbody>  
...
<div id="column_edit_frame" class="layerdiv">
  ...
  <div class="layer_inner"> 
    <div class="layer_move" id="move_column" title="点击此处可自由拖动"><h1>站点</h1></div>
   ...
   <%-- <div class="layer_T">
    ...
    <div class="layer_C">
        <table cellspacing="0" cellpadding="0" class="form_list">
          <tbody>
            <tr>
            <td class="form_name" >站点名称：</td>
            <td class="form_field">
                <input id="SiteName" pid="valueList" type="text" />
            </td>
            </tr>  
            <tr>
                <td class="form_name" >站点域名：</td>
                <td class="form_field">
                    <input id="DomainName" pid="valueList" type="text" />
                </td>
            </tr> 
            <tr>
                <td class="form_name" >模板存放路径：</td>
                <td class="form_field">
                    <input id="TemplatePath" pid="valueList" type="text" />
                </td>
            </tr> 
            <tr>
                <td class="form_name" >站点生成路径：</td>
                <td class="form_field">
                    <input id="PublishPath" pid="valueList" type="text" />
                </td>
            </tr>                 
          </tbody>
        </table>
