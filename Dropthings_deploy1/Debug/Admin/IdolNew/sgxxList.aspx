<%@ page language="C#" autoeventwireup="true" inherits="Admin_IdolNew_sgxxList, Dropthings_deploy1" enableEventValidation="false" theme="GreenBlue" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../js/sgxxIdolNew.js"></script>
                    ...
                    <tr>
                        ...
                        <td bgcolor="#d3e7fc">
                            ...
                            <li>
                              ...
                              <span class="input"><select id="info_type">
                              ...
                              <span class="input"><select id="info_site" style="width:60px;">>
                                    <option selected="selected" value="all">全部</option>
                           ...
                           <input type="checkbox" name="databse_list" checked="checked"  value="portalsafety+Safety" />发布库                     
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CECECE">
                                <tr>
                                    ...
                                    <td width="28%" background="../images/tab_14.gif" align="center">标题</td>
                                    ...
                                    <td width="10%" id="dis_article_column" style=" display:none; " background="../images/tab_14.gif" align="center">所属栏目</td>
