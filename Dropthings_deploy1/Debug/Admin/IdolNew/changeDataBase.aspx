<%@ page language="C#" autoeventwireup="true" inherits="Admin_IdolNew_changeDataBase, Dropthings_deploy1" enableEventValidation="false" theme="GreenBlue" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../js/changedatabase.js"></script>
</head>
<body style="background:#ffffff;">
            ...
            <td height="30">
                <table width="100%" border="0" cellspacing="0" cellpadding="0"  >
                    <tr>
                        ...
                        <td background="../images/tab_05.gif" align="left"><img src="../images/311.gif" width="16" height="16" /><span class="STYLE4">信息列表</span></td>
                        ...
                        <td bgcolor="#d3e7fc">
                            ...
                            <li>
                              ...
                              <span class="input"><select id="sort_style" style="width:60px;">
                                    ...
                                    <option selected="selected" value="Relevance">相关度</option>
                                </select></span>
                              ...
                              <span class="input"><select id="info_type" style="width:60px;">>
                                ...
                                <span class="name">站点选择：</span>
                              <span class="input"><select id="info_site">
                                    <option selected="selected" value="all">全部</option>
                                    
                                </select></span>
                            </li>
                            <li>
                            <span id="databse_list" style="padding-left:22px;"><%--style="padding-left:22px;"新加20120507--%>
                           
                           
                           <%--<input type="checkbox" name="databse_list" value="NewsSource" />基础库&nbsp;&nbsp;&nbsp;
                           <input type="checkbox" name="databse_list" checked="checked" value="Safety" />安全生产库&nbsp;&nbsp;&nbsp;
                           <input type="checkbox" name="databse_list"  value="bbs" />信息回收站                --%>     
                           ...
                           <div class="clear"></div>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CECECE">
                                <tr>
                                    ...
                                    <td width="15%" id="look_same_news" style=" display:none; " background="../images/tab_14.gif" align="center">查看相同新闻</td>
                                </tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="21%" align="left">&nbsp;
                                        ...
                                        <a href="javascript:void(null);" id="all_news_store">
                                            <img alt="归档" src="../images/gd.gif" width="64" height="19" />
                                        </a>
                                        <a href="javascript:void(null);" id="btn_delete_all" >
    ...
    <div id="column_edit_frame" class="layerdiv">
      ...
      <div class="layer_inner"> 
        <div class="layer_move" id="move_column" title="点击此处可自由拖动"><h1>目标库选择</h1></div>
...
<%--        <div class="layer_T">
    ...
    <div id="same_news_frame" class="layerdiv">
      ...
      <span class="layer_top_R"></span>--%>
      <div class="layer_inner"> 
        <div class="layer_move" id="move_same_news" title="点击此处可自由拖动">&nbsp;</div>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CECECE">
                                <tr>
                                    <td width="50%" height="26" background="../images/tab_14.gif" align="center">标题</td>
                                    <td width="25%" background="../images/tab_14.gif" align="center">时间</td>
                                    <td width="25%" background="../images/tab_14.gif" align="center">来源</td>
                                    </tr>
