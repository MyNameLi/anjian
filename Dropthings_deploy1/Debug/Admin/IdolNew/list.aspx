<%@ page language="C#" autoeventwireup="true" inherits="Admin_IdolNew_list, Dropthings_deploy1" enableEventValidation="false" theme="GreenBlue" %>
                           ...
                           <input type="checkbox" name="databse_list" checked="checked"  value="portalsafety" />发布库 --%>                    
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CECECE">
                                <tr>
                                    ...
                                    <td width="25%" background="../images/tab_14.gif" align="center">标题</td>
                                    <td width="14%" background="../images/tab_14.gif" align="center">时间</td>
                                    <td width="14%" background="../images/tab_14.gif" align="center">所属站点</td>
                                    <td width="7%" background="../images/tab_14.gif" align="center">栏目定制</td>
                                    <td width="7%" background="../images/tab_14.gif" align="center">信息过滤</td>                                   
                                    <td width="7%" background="../images/tab_14.gif" align="center">相关度</td>
                                    <td width="7%" background="../images/tab_14.gif" align="center">查看快照</td>
                                    <td width="10%" id="look_same_news" style=" display:none; " background="../images/tab_14.gif" align="center">查看相同新闻</td>
                                    <td width="15%" id="dis_article_column" style=" display:none; " background="../images/tab_14.gif" align="center">所属栏目</td>
