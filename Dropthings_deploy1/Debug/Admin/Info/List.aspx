<%@ page language="C#" autoeventwireup="true" inherits="Admin_Info_List, Dropthings_deploy1" enableEventValidation="false" theme="GreenBlue" %>
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="../images/tab_05.gif" align="left"><img src="../images/311.gif" width="16" height="16" /> <span class="STYLE4">信息列表</span>
            ...
            <asp:Repeater ID="dataList" runat="server">
                <HeaderTemplate>
                  <tr>
                    ...
                    <td width="44%" background="../images/tab_14.gif" align="center">标题</td>
                                       
                    <td width="18%" background="../images/tab_14.gif" align="center">发送者</td> 
                    <td width="12%" background="../images/tab_14.gif" align="center">发送时间</td>                   
                    <td width="20%" background="../images/tab_14.gif" align="center">操作</td>
                  </tr>          
                ...
                <ItemTemplate>
                  <tr class="info_list_<%#Eval("Status") %>">
                    ...
                    <td bgcolor="#FFFFFF" align="center"><img src="../images/037.gif" width="9" height="9" />[ <a name="BtnInfoLook" href="javascript:void(null);" pid="<%#Eval("ID") %>">查看</a> ]
                    &nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/010.gif" width="9" height="9" />[ <a href="javascript:void(null);" onClick="javascript:listTable.Remove(<%#Eval("ID") %>,'您确定要删除么？');">删除</a> ]</td>
                  </tr>  
                </ItemTemplate>  
                <FooterTemplate>
                    </tbody>
...
<div id="column_edit_frame" class="layerdiv">
  ...
  <div class="layer_inner"> 
    <div class="layer_move" id="move_column" title="点击此处可自由拖动"><h1>详细信息</h1></div>
...
<%--    <div class="layer_T">
    ...
    <div class="layer_C">
        <table cellspacing="0" cellpadding="0" class="form_list">
          <tbody>
            <tr>
            <td class="form_name" >信息留言：</td>
            <td class="form_field">
                <span id="Message"></span>
            </td>
            </tr>  
            <tr>
                <td class="form_name" >信息标题：</td>
                <td class="form_field">
                    <span id="InfoTitle"></span>
                </td>
            </tr> 
            <tr>
                <td class="form_name" >信息内容：</td>
                <td class="form_field">
