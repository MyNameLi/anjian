<%@ page language="C#" autoeventwireup="true" inherits="Admin_IdolNew_sgxxchangeDataBase, Dropthings_deploy1" enableEventValidation="false" theme="GreenBlue" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../js/sgxxchangedatabase.js"></script>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td bgcolor="#d3e7fc">
                            ...
                            <li>
                                      <span >
                           数据源：<input type="checkbox" name="databse_list" value="NewsSource" />基础库&nbsp;&nbsp;&nbsp;
                           <input type="checkbox" name="databse_list" checked="checked" value="Safety+PortalSafety" />事故信息库&nbsp;&nbsp;&nbsp;
                           ...
                           <div class="clear"></div>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CECECE">
                                <tr>
                                    ...
                                    <td width="38%" background="../images/tab_14.gif" align="center">标题</td>
