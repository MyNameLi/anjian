<%@ page language="C#" autoeventwireup="true" inherits="Admin_BriefReport_list, Dropthings_deploy1" enableEventValidation="false" theme="GreenBlue" %>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td background="../images/tab_05.gif" align="left">
                                ...
                                <span class="STYLE4">报表列表</span> <span style="float: right;">
                                    <input id="report_upload" type="button" value="上传简报" /></span>
                            </td>
                            <td width="14">
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#FFFFFF" align="center">
                                                    <img src="../images/037.gif" width="9" height="9" alt="查看" />[ <a href="javascript:void(null);"
                                                        name="look_report" pid='<%#Eval("URL")%>'>查看</a> ]
                                                </td>
                                                <td bgcolor="#FFFFFF" align="center">
                                                ...
                                                <td bgcolor="#FFFFFF" align="center">
                                                    <img src="../images/010.gif" width="9" height="9" alt="删除" />[ <a href="javascript:void(null);"
                                                        name="delete_report" cate="<%#Eval("URL")%>" pid='<%#Eval("ID") %>'>删除</a> ]
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
                    ...
                    <table cellspacing="0" cellpadding="0" class="form_list">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="form_field">
                                    <input id="ReportCreater" type="text" />
                                </td>
                            </tr>
                            <tr>
                                <td class="form_name">
                            ...
                            <tr>
                                ...
                                <td class="form_field">
                                    <select id="ReportType">
                                        ...
                                        <option value="2">专报</option>
                                        <option value="3">月报</option>
                                        <option value="4">事故信息</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
