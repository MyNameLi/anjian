<%@ page language="C#" autoeventwireup="true" inherits="Admin_website_list, Dropthings_deploy1" enableEventValidation="false" theme="GreenBlue" %>
            ...
            <asp:Repeater ID="dataList" runat="server">
                <HeaderTemplate>
                  <tr>
                    ...
                    <td width="24%" background="../images/tab_14.gif" align="center">网站名称</td>
                    <td width="56%" background="../images/tab_14.gif" align="center">网站链接</td>                    
                ...
                <ItemTemplate>
                  <tr>
                    ...
                    <td bgcolor="#FFFFFF" align="center"><%#Eval("WEBSITENAME")%></td>
                    <td bgcolor="#FFFFFF" align="center"><a href="#"><%#Eval("WEBSITEURL")%></a></td>
...
<div id="column_edit_frame" class="layerdiv">
  ...
  <div class="layer_inner"> 
    <div class="layer_move" id="move_column" title="点击此处可自由拖动"><h1>站点管理</h1></div>
    ...
    <div class="layer_C">
        <table cellspacing="0" cellpadding="0" class="form_list">
          <tbody>
            <tr>
            <td class="form_name" >网站名称：</td>
            <td class="form_field">
                <input id="WebSiteName" pid="valueList" type="text" />
            </td>
            </tr>  
            <tr>
                <td class="form_name" >网站链接：</td>
                <td class="form_field">
                    <textarea id="WebSiteUrl" cols="40" rows="2" pid="valueList"></textarea>
                </td>
            </tr>                      
          </tbody>
        </table>
