...
var province = {
    PageInitParameter: { "page_size": 8, "result_id": "pagelist", "status_bar_id": "pagebar", "post_url": "Handler/GetProvinceInfo.ashx" },
    Init: function () {
        Common.GetTab('tabs');
    ...
    LoadMap: function (cdata) {
        //        var top5 = { "北京": 70000, "广东": 70000, "福建": 70000, "山东": 70000, "浙江": 70000, "上海": 5000, "江苏": 5000, "河南": 5000, "河北": 5000, "辽宁": 5000, "四川": 3000, "山西": 3000, "陕西": 3000, "安徽": 3000, "湖北": 3000, "湖南": 2000 };
    ...
    Lpager.Display = function (data) {
        if (data["totalcount"] && data["totalcount"] > 0) {
            ...
            while (entity) {
                ...
                //打开新窗口查看
                province_topics.push("<a href=\"" + unescape(entity["href"]) + "\" target=\"_blank\" >" + GetShortWord(unescape(entity["title"]), 54) + "</a>");
                province_topics.push("</span>");
                province_topics.push("<span class=\"new_pos02\">" + GetShortWord(unescape(entity["site"]), 50) + "</span>");
