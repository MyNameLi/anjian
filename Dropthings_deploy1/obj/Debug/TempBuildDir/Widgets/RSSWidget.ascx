<%@ control language="C#" autoeventwireup="true" inherits="Widgets_RSSWidget, Dropthings_deploy1" enableviewstate="false" %>
<asp:Panel ID="SettingsPanel" runat="Server" Visible="False">
    <asp:Literal ID="ltlURL" EnableViewState="false" runat="server" Text="<%$Resources:SharedResources, URL%>" />:
    <asp:TextBox ID="FeedUrl" Text="" runat="server" MaxLength="2000" Columns="40" /><br />
...
<asp:MultiView ID="RSSMultiview" runat="server" ActiveViewIndex="0">
    <asp:View runat="server" ID="RSSProgressView">
        <asp:Label runat="Server" ID="label1" Text="<%$Resources:SharedResources, Loading%>"
            Font-Size="smaller" ForeColor="DimGray" />
    </asp:View>
