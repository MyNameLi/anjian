<%@ control language="C#" autoeventwireup="true" inherits="WidgetContainer, Dropthings_deploy1" %>
<asp:Panel ID="Widget" CssClass="widget" runat="server" onmouseover="this.className='widget widget_hover'"
    onmouseout="this.className='widget'">
    ...
    <div class="widget_outer">
            ...
            <asp:UpdatePanel ID="WidgetHeaderUpdatePanel" runat="server" UpdateMode="Conditional"
                ...
                <ContentTemplate>
                        ...
                        <tbody>
                            <tr>
                                <td class="widget_title" colspan="4">
                                    <asp:Image ID="LockedWidget" AlternateText="Locked" runat="server" ImageUrl="~/App_Themes/GreenBlue/Images/Widget/locked.png"
                                        Visible="false" /><asp:LinkButton ID="WidgetTitle" OnClick="WidgetTitle_Click" runat="Server"
                                            Text="<%$Resources:SharedResources, WidgetTitle%>" CssClass="widget_title_label" /><asp:TextBox
                                                ID="WidgetTitleTextBox" runat="Server" CssClass="widget_title_input" /><asp:Button
                                                    ID="SaveWidgetTitle" OnClick="SaveWidgetTitle_Click" runat="Server" CssClass="widget_title_submit"
                                                    Text="<%$Resources:SharedResources, Ok%>" />
                                </td>
                    ...
                    <td class="widget_button"><asp:LinkButton ID="CollapseWidget" OnClick="CollapseWidget_Click" runat="Server" Text="" CssClass="widget_min widget_box" /><asp:LinkButton ID="ExpandWidget" OnClick="ExpandWidget_Click" runat="Server" Text="" CssClass="widget_expand widget_box" />--%></td>
                                <td class="widget_button" style="float: right;">
        ...
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" DisplayAfter="10" AssociatedUpdatePanelID="WidgetBodyUpdatePanel">
            <ProgressTemplate>
                <center>
                    <asp:Literal ID="ltlWorking" EnableViewState="false" runat="server" Text="<%$Resources:SharedResources, Working%>" /></center>
            </ProgressTemplate>
        </asp:UpdateProgress>
        <asp:UpdatePanel ID="WidgetBodyUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:Panel ID="WidgetResizeFrame" CssClass="widget_resize_frame" runat="server">
                    <asp:Panel ID="WidgetBodyPanel" runat="Server" CssClass="widget_body">
                    </asp:Panel>
                </asp:Panel>
            </ContentTemplate>
        </asp:UpdatePanel>
