...
public partial class WidgetInstanceZone : System.Web.UI.UserControl
{
    ...
    public IEnumerable<WidgetInstanceEntity> WidgetInstances
    {
        get; set;
    }
    ...
    private IWidgetHost CreateWidgetContainerFromWidgetInstance(EventBrokerService eventBroker, WidgetInstanceEntity instance)
    {
        ...
        widgetHost.Deleted += new Action<WidgetInstanceEntity, IWidgetHost>(Widget_Deleted);

        return widgetHost;
    }

    public void AddNewWidget(EventBrokerService eventBroker, WidgetInstanceEntity instance)
    {
        var widgetHost = CreateWidgetContainerFromWidgetInstance(eventBroker, instance);
    ...
    private void Widget_Deleted(WidgetInstanceEntity wi, IWidgetHost host)
    {
        if (host is Control)
