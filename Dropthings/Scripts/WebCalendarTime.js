...
String.prototype.toDate = function(style) {   
  ...
  if(m!="15"||m!="30"||m!="45"||m!="00")//判断分钟的选择项
  {
    if(m>="45")
    {
        h+=1;
...
<head id="Head1">  
        <script src="/Resources/JS/WebCalendar.js" type="text/javascript"></script>  
</head>  
<body>  
