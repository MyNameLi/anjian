...
public partial class Widgets_FastRssWidget : System.Web.UI.UserControl, IWidget
{
            ...
            if (_State == null)
            {
                ...
                if (string.IsNullOrEmpty(stateXml))
                {
                    ...
                    _State = new XElement("state",
                        new XElement("url", "http://rss.sina.com.cn/news/allnews/tech.xml"),
                        new XElement("count", "6"));
                }
                else
                {
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        string[] scriptToLoad = { ResolveClientUrl("~/Widgets/FastRssWidget.js?v=" + ConstantHelper.ScriptVersionNo) };
