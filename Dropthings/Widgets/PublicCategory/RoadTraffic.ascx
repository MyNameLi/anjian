<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RoadTraffic.ascx.cs" Inherits="Widgets_PublicCategory_RoadTraffic" %>
<div class="news_tab">
  <ul class="form_list">
    ...
    <ul id="SearchResult_RoadTraffic" class="news_list">
    </ul>
    <div id="PagerList_RoadTraffic" class="publicFeelSearchPage">
    </div>
