<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Colliery.ascx.cs" Inherits="Widgets_PublicCategory_Colliery" %>
<div class="news_tab">
  <ul class="form_list">
  ...
  <ul id="SearchResult" class="news_list">
  </ul>
  <div id="PagerList" class="publicFeelSearchPage"> </div>
