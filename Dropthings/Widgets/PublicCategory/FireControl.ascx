<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FireControl.ascx.cs" Inherits="Widgets_PublicCategory_FireControl" %>
<div class="news_tab">
  <ul class="form_list">
    ...
    <ul id="SearchResult_FireControl" class="news_list">
    </ul>
    <div id="PagerList_FireControl" class="publicFeelSearchPage">
    </div>
