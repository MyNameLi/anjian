<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NonColliery.ascx.cs" Inherits="Widgets_PublicCategory_NonColliery" %>
<div class="news_tab">
  <ul class="form_list">
    ...
    <ul id="SearchResult_NonColliery" class="news_list">
    </ul>
    <div id="PagerList_NonColliery" class="publicFeelSearchPage">
    </div>