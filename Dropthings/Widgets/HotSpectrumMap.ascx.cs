...
public partial class Widgets_HotSpectrumMap : System.Web.UI.UserControl, IWidget
{
    ...
    {
        base.OnPreRender(e);
        string[] scriptToLoad = { ResolveClientUrl("~/Widgets/HotSpectrumMap.js?v=" + ConstantHelper.ScriptVersionNo) };
        var startUpCode = string.Format("window.hotSpectrumMapLoader{0}_{1} = HotSpectrumMap; window.hotSpectrumMapLoader{0}_{1}.Load();",
