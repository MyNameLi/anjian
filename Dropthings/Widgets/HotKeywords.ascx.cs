...
public partial class Widgets_HotKeywords : System.Web.UI.UserControl, IWidget
{
    ...
    {
        base.OnPreRender(e);
        string[] scriptToLoad = { ResolveClientUrl("~/Scripts/Bar.js?v=" + ConstantHelper.ScriptVersionNo), ResolveClientUrl("~/Widgets/HotKeywords.js?v=" + ConstantHelper.ScriptVersionNo) };
        var startUpCode = string.Format("window.hotKeywordsLoader{0}_{1} = HotKeywords; window.hotKeywordsLoader{0}_{1}.Load();",
                this._Host.ID, this.HotKeywordsContainer.ClientID);
