...
namespace VTemplate.Engine
{
    ...
    public class TemplateDocument : Template
    {
        ...
        {
            dict = (Dictionary<string, string>)System.Web.HttpContext.Current.Session["Lable"];
        ...
        private string LoadLable(string text, Dictionary<string, string> labledict) {
            foreach (string key in labledict.Keys)
            {
                text = text.Replace(key, labledict[key]);
            }
            return text;
        }
        ...
        /// <param name="charset"></param>
        /// <returns></returns>
        public static TemplateDocument FromFileCache(string fileName, Encoding charset,Dictionary<string,string> labledict)
        {
            return FromFileCache(fileName, charset, TemplateDocumentConfig.Default,labledict);
        }
        /// <summary>
        /// 从文件缓存中构建模板文档对象
        /// </summary>
        ...
        /// <param name="documentConfig"></param>
        /// <returns></returns>
        public static TemplateDocument FromFileCache(string fileName, Encoding charset, TemplateDocumentConfig documentConfig,Dictionary<string,string> labledict)
        {
